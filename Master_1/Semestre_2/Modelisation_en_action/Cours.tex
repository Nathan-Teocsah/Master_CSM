...
\begin{document}
	...
	\underbrace{e^{i\operatorname{Re}(k)nP}}_{\textcolor{red}{\text{Changement de phase}}}\cdot \quad u(x)
	\]
	...
	$U(x,t) = U_n(x,t) = \operatorname{Re}\left(u_n(\omega)e^{-i\omega t}\right)$ qui s'écrit d'après le principe de Floquet-Bloch :
	
	\begin{minipage}{6cm}
		\begin{tcolorbox}[colback=white, colframe=red, arc=1mm, boxrule=1pt]
			$U_n(t) = \operatorname{Re}\left(u_n(\omega)e^{i(nkp-\omega t)}\right)$
		\end{tcolorbox}
	\end{minipage} , où $u_(\omega)$ 0est l'amplitude de l'onde.\\
