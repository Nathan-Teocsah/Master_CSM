...
\begin{document}
	...
	$-2\omega^2 = \underbrace{\frac{4\beta}{m}}_{\omega_0^2}\left(\frac{e^{ika}+e^{ika}}{2} - 1\right)$, on introduit : $\begin{cases}[t]
		\lambda = e^{ika}\\
		\lambda^{-1} = e^{-ika}
	\end{cases}$ 
	...
	\subsection{Chaîne di-atomique}
		...
		\[
		\lambda = (2\Gamma-1)\pm2\sqrt{(\Omega_1-1)(\Omega_2-1)(\Gamma-1)}
		\]
	...
	\begin{ex}[Suite de l'exercice précédent] Écrire (1) sous la forme $\omega(k)$ c'est-à-dire : $(A-\omega^2B)\emptyset = 0$.
	\end{ex}
	\begin{sol}
		\[\begin{aligned}
