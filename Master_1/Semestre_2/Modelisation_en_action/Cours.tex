...
\begin{document}
	...
	Ainsi $\left(\mathcal T u\right)(x) = \lambda u(n)$ ce qui revient à dire que c'est un vecteur propre de $\mathcal T$ et $\lambda$ est valeur propre, est dit "Multiplicateur de Floquet".
	...
	\begin{minipage}{6cm}
		...
		\end{tcolorbox}
	\end{minipage} , où $u_n(\omega)$ est l'amplitude de l'onde.\\
