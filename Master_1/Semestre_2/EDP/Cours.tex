...
\begin{document}
	...
	\begin{ex}[Newton bis]
		...
		\begin{minipage}[t]{17cm}
			On a déjà vu que, si $f(t,x_1,v_1,\ldots,x_N,v_N)$ = \begin{minipage}[t]{7cm}
			la densité de particule\\ à l'instant $t$ en $(x_1,v_1,\ldots,x_N,v_N)$
		\end{minipage}
		\end{minipage}
		
		qui $f(t,X_1(t,0,z),V_1(t,0,z),\ldots,X_d(t,0,z),V_d(t,0,z)) = f^0(z)$
		...
		\[
		\dfrac{\partial f}{\partial t}(t,x_1,v_1,\ldots,v_N,v_N) + v_1 \cdot \nabla_{x_1} f + \displaystyle\sum_{k=1}^N \left(\frac{1}{N} \sum_{\underset{j\not=k}{j=1}}^N F(x_k-x_j)\right)\cdot\nabla_{v_k}f = 0
		\]
		
	\end{ex}
	
	Pour recoller tout cela nous avons montrer :
