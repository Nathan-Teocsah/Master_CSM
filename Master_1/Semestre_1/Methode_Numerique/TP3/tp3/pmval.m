...
% La ligne i de p contient les coeficients du polynome
%    correspondant a l'intervalle [x(i),x(i+1)].
% Sur chaque intervalle [x(i),x(i+1)] on evalue p en nbpi+2 points equidistants.
% y : vecteur des valeurs du polynome aux points d'evaluation xe.
n=length(x)-1;xe=[];y=[];
for i=1:n
