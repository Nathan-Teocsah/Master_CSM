...
void initiate_A_b(Matrix_double  *A,  Matrix_double  *A_copie,  Matrix_double * X,Matrix_double  *b, Matrix_double * Res,  double h)
{
  // Initialisation des matrices et vecteurs nécessaire
  // a l'algorithme.
  // A = A_copie
  // A, X, b : AX = b
  // Res : résultat des calculs intermédiaire
